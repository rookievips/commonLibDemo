 ...
 */
package com.chen.api.ptr.header;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = DisplayUtil.dp2px(Y_OFFSET);
        final int shadowXOffset = DisplayUtil.dp2px(X_OFFSET);
        int mShadowRadius = DisplayUtil.dp2px(SHADOW_RADIUS);
