...
import com.chen.api.http.volley.Request.Method;
...
public class HurlStack implements HttpStack {
    ...
    /**
     * @param urlRewriter Rewriter to use for requestSilent URLs
     */
    ...
    /* package */ static void setConnectionParametersForRequest(HttpURLConnection connection, Request<?> request)
        ...
        switch (request.getMethod()) {
            case Method.DEPRECATED_GET_OR_POST:
                ...
                // compatibility.
                // If the requestSilent's post body is null, then the assumption is that
                // the requestSilent is
                // GET. Otherwise, it is assumed that the requestSilent is a POST.
                ...
                break;
            case Method.GET:
                // Not necessary to set the requestSilent method because connection
                // defaults to GET but
                // being explicit here.
