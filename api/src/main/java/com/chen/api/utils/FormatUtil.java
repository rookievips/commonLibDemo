...
public class FormatUtil {
     ...
     * 验证手机格式
     */
    public static boolean checkIsMobileNumber(String mobiles) {
		/*
     ...
     * @return
     */
    public static boolean checkIsCarNumber(String value) {
        return Pattern.compile("^[\\u4E00-\\u9FA5][\\da-zA-Z]{6}$").matcher(value).matches();
    }
     ...
     * 判断身份证格式
     */
    public static boolean checkIsIDCard(String idNum) {
     ...
     */
    public static boolean isIDCardValid(String IDStr) throws ParseException {
    ...
    private static char getBankCardCheckCode(String nonCheckCodeCardId) {
        ...
        return (luSum % 10 == 0) ? '0' : (char) ((10 - luSum % 10) + '0');
    }
    ...
    private static Hashtable SetAreaCode() {
     ...
     * @return
     */
    public static String formatNum(String formatRule, double num) {
        DecimalFormat df = new DecimalFormat(formatRule);
