...
//        mCircleAnimator.start();
    ...
    protected void onDetachedFromWindow() {
        ...
        Log.d("chen","进入 onDetachedFromWindow () 方法");
        ...
        if (mWrong1Animator != null && mWrong1Animator.isRunning()) {
            mWrong1Animator.cancel();
        }
        if (mWrong2Animator != null && mWrong2Animator.isRunning()) {
            mWrong2Animator.cancel();
        }
    }
}
